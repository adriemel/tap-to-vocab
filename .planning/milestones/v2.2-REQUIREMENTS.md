# Requirements Archive: v2.2 Topics & Unidades
...
| TAG-01 | Phase 23 | Complete |
| TAG-02 | Phase 23 | Complete |
| TAG-03 | Phase 23 | Complete |
| TAG-04 | Phase 23 | Complete |
| TAG-05 | Phase 23 | Complete |
| TAG-06 | Phase 23 | Complete |
...
| NAV-07 | Phase 23 | Complete |

**Coverage:**
- v2.2 requirements: 16 total
- Mapped to phases: 16 (Phase 23: 10, Phase 24: 6)
- Unmapped: 0
- Completed: 16/16 — all validated (Phase 23 verification 5/5; Phase 24 verification 10/10, UAT 9/9)

## Outcomes

All 16 requirements validated; none dropped.

- **DATA-03 / DATA-04 — adjusted in scope:** the source images held 27 headwords and 17 sentences, not the estimated ~24 / ~15; all were imported.
- **TAG-03 / TAG-05 — adjusted in naming:** multi-word topics are stored as slugs (`Casa_Familia`, `Comida_Bebida`); the hub buttons show "Casa y Familia" / "Comida y Bebida", while `topic.html` headings show the raw slug (accepted in UAT, polish deferred).
- **TAG-01 — as specified:** 118 of 125 Palabras headwords partitioned; the rest keep `topics: Palabras`.
- **NAV-06 — strengthened:** topic lists are deduplicated on `es`+`de` (code review CR-01), so a word tagged in several unidades appears once.
- **NAV-07 — proven mechanically:** all 708 pre-phase Spanish+German pairs survive the re-tagging.
